...
subset_consensus <- function(df) {
  ...
  feature_importances <- c(
    ...
    'HumanProteinAtlas.Sc_1_Neuron' = 0.043544331,
    'CellMarker_1_Astrocyte' = 0.040819327,
    'CellMarker_1_Oligodendrocyte' = 0.032590162,
    'HumanProteinAtlas.Sc_2_Neuron' = 0.030488439,
    'HumanProteinAtlas.IHC_1_Neuron' = 0.028815387,
    'HumanProteinAtlas.Sc_1_Microglia' = 0.027871681,
    'PanglaoDB_2_OPC' = 0.026462154085044928,
    'HumanProteinAtlas.Sc_2_Microglia' = 0.026314308,
    'HumanProteinAtlas.Sc_1_OPC' = 0.025928987135901093,
    'HumanProteinAtlas.IHC_1_Endothelial' = 0.025586259192442343,
    'HumanProteinAtlas.Sc_1_Astrocyte' = 0.019222877525104674,
    ...
    'HumanProteinAtlas.Sc_2_Astrocyte' = 0.011105882635877118,
    'PanglaoDB_1_Neuron' = 0.010954553874500284,
    'HumanProteinAtlas.IHC_2_Endothelial' = 0.010610705103308946,
    ...
    'HumanProteinAtlas.Sc_1_Oligodendrocyte' = 0.006961914,
